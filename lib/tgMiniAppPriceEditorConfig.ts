...
const LABELS: Partial<Record<keyof CalculatorPriceList, { label: string; hint?: string; suffix?: string }>> =
  {
    standard_7: { label: "Мощность 7 кВт", hint: "Цена за 1 монтаж" },
    standard_9: { label: "Мощность 9 кВт", hint: "Цена за 1 монтаж" },
    standard_12: { label: "Мощность 12 кВт", hint: "Цена за 1 монтаж" },
    standard_18: { label: "Мощность 18 кВт", hint: "Цена за 1 монтаж" },
    standard_24: { label: "Мощность 24 кВт", hint: "Цена за 1 монтаж" },
    standard_30: { label: "Мощность 30 кВт", hint: "Цена за 1 монтаж" },
    standard_36: { label: "Мощность 36 кВт", hint: "Цена за 1 монтаж" },
    existing_7: { label: "Мощность 7 кВт", hint: "Цена за 1 монтаж" },
    existing_9: { label: "Мощность 9 кВт", hint: "Цена за 1 монтаж" },
    existing_12: { label: "Мощность 12 кВт", hint: "Цена за 1 монтаж" },
    existing_18: { label: "Мощность 18 кВт", hint: "Цена за 1 монтаж" },
    existing_24: { label: "Мощность 24 кВт", hint: "Цена за 1 монтаж" },
    existing_30: { label: "Мощность 30 кВт", hint: "Цена за 1 монтаж" },
    existing_36: { label: "Мощность 36 кВт", hint: "Цена за 1 монтаж" },
    route_7: { label: "Трасса 7 кВт", hint: "Цена за 1 м", suffix: "₽/м" },
    route_9: { label: "Трасса 9 кВт", hint: "Цена за 1 м", suffix: "₽/м" },
    route_12: { label: "Трасса 12 кВт", hint: "Цена за 1 м", suffix: "₽/м" },
    route_18: { label: "Трасса 18 кВт", hint: "Цена за 1 м", suffix: "₽/м" },
    route_24: { label: "Трасса 24 кВт", hint: "Цена за 1 м", suffix: "₽/м" },
    route_30: { label: "Трасса 30 кВт", hint: "Цена за 1 м", suffix: "₽/м" },
    route_36: { label: "Трасса 36 кВт", hint: "Цена за 1 м", suffix: "₽/м" },
    ...
    stroba_brick_small: {
      label: "Штроба кирпич / газоблок до 24 кВт",
      hint: "Цена за 1 м",
      suffix: "₽/м",
    },
    stroba_brick_big: {
      label: "Штроба кирпич / газоблок от 30 кВт",
      hint: "Цена за 1 м",
      suffix: "₽/м",
    },
    stroba_concrete_small: {
      label: "Штроба бетон до 24 кВт",
      hint: "Цена за 1 м",
      suffix: "₽/м",
    },
    stroba_concrete_big: {
      label: "Штроба бетон от 30 кВт",
      hint: "Цена за 1 м",
      suffix: "₽/м",
    },

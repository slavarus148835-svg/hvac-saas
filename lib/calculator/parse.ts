...
export function normalizeCalculatorComputeInput(
  ...
  return {
    ...
    cable40Meters: sanitizeNonNegativeIntString(cable40Meters, MAX_CABLE_METERS) || "0",
    cable16Meters: sanitizeNonNegativeIntString(cable16Meters, MAX_CABLE_METERS) || "0",
